...
INSERT INTO qualification_questions (question_text, question_type, options, placeholder, is_required, is_disqualifying, disqualifying_answers, display_order) VALUES
('What is your full name?', 'text', NULL, 'Enter your full name', true, false, NULL, 1),
('What is your email address?', 'email', NULL, 'Enter your email', true, false, NULL, 2),
('What is your phone number?', 'phone', NULL, '+1 (555) 000-0000', true, false, NULL, 3),
('What country are you located in?', 'text', NULL, 'Enter your country', true, false, NULL, 4),
('How would you describe your trading experience?', 'select', '["Complete Beginner", "Some Experience (< 1 year)", "Intermediate (1-3 years)", "Advanced (3+ years)"]', NULL, true, false, NULL, 5),
('How much capital do you have available for trading?', 'select', '["Less than $500", "$500 - $2,000", "$2,000 - $10,000", "$10,000 - $50,000", "$50,000+"]', NULL, true, true, '["Less than $500"]', 6),
('How many hours per week can you dedicate to learning and trading?', 'select', '["Less than 5 hours", "5-10 hours", "10-20 hours", "20+ hours"]', NULL, true, true, '["Less than 5 hours"]', 7),
('Are you willing to invest in your trading education?', 'select', '["Yes, I am ready to invest", "Maybe, depends on the value", "No, I am looking for free resources only"]', NULL, true, true, '["No, I am looking for free resources only"]', 8),
('What is your primary goal with trading?', 'select', '["Replace my full-time income", "Supplement my current income", "Build long-term wealth", "Just curious/hobby"]', NULL, true, true, '["Just curious/hobby"]', 9),
('What is your biggest challenge with trading right now?', 'textarea', NULL, 'Describe your biggest challenge...', true, false, NULL, 10),
('Why do you want to join this mentorship program?', 'textarea', NULL, 'Tell us why you want to join...', true, false, NULL, 11);
